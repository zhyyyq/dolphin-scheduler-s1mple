  ...
  const columns = [
    ...
    { title: '结束时间', dataIndex: 'endTime', key: 'endTime' },
    {
      ...
      render: (_: any, record: any) => (
        //{window.schedulerSdk.change_route(`/instances/${record.projectCode}/${record.id}`)}
        <Button onClick={()=>window.schedulerSdk.check_instance_detail(record.projectCode, record.id)}>查看详情</Button>
      ),
    },
  ];
