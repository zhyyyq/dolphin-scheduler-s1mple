...
import { ApartmentOutlined, PlusOutlined, HistoryOutlined, CodeOutlined } from '@ant-design/icons';
  ...
  <Col xs={24} sm={12} md={6}>
    <Card hoverable style={{ display: 'flex', flexDirection: 'column', height: '100%', textAlign: 'center' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: 'auto' }}>
          <Button type="primary" onClick={()=>{window.schedulerSdk.change_route(link)}}>{buttonText}</Button>
      </div>
    </Card>
  </Col>
);
